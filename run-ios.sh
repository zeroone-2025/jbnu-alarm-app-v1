...
echo -e "  ${GREEN}2)${NC} 개발 서버 (https://dev-api.zerotime.kr:17181)"
echo -e "  ${GREEN}3)${NC} 프로덕션 서버 (https://api.zerotime.kr:17044)"
echo ""
...
case $env_choice in
    1)
        ...
        ;;
    2)
        API_URL="https://dev-api.zerotime.kr:17181"
        ENV_NAME="개발"
        ;;
    3)
        API_URL="https://api.zerotime.kr:17044"
        ENV_NAME="프로덕션"
        ;;
    *)
