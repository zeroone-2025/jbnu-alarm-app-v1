...
export type ProfileTabType = 'basic' | 'timetable' | 'history';
...
export default function ProfileTabs({ activeTab, onTabChange }: ProfileTabsProps) {
  ...
  return (
    <div ref={containerRef} className="relative flex w-full overflow-x-auto border-b border-gray-200 no-scrollbar">
      {TABS.map((tab) => (
        <button
          key={tab.key}
