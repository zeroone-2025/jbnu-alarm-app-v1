...
export const BOARD_MAP: Record<string, BoardMeta> = {
  ...
  dept_business: { name: "경영학과", color: "indigo", category: "학과" },
  dept_economics: { name: "경제학부", color: "indigo", category: "학과" },
  dept_mechanical: { name: "기계공학", color: "indigo", category: "학과" },
  dept_mse: { name: "기계시스템공학부", color: "indigo", category: "학과" },
  dept_animalsci: { name: "동물자원과학과", color: "indigo", category: "학과" },
  dept_trade: { name: "무역학과", color: "indigo", category: "학과" },
  dept_lis: { name: "문헌정보학과", color: "indigo", category: "학과" },
  dept_physics: { name: "물리학과", color: "indigo", category: "학과" },
  dept_semi: { name: "반도체과학기술학과", color: "indigo", category: "학과" },
  dept_molbio: { name: "분자생물학과", color: "indigo", category: "학과" },
  dept_history: { name: "사학과", color: "indigo", category: "학과" },
  dept_welfare: { name: "사회복지학과", color: "indigo", category: "학과" },
  dept_sociology: { name: "사회학과", color: "indigo", category: "학과" },
  dept_biotech: { name: "생명공학부", color: "indigo", category: "학과" },
  dept_bioedu: { name: "생물교육학과", color: "indigo", category: "학과" },
  dept_bime: { name: "생물산업기계공학과", color: "indigo", category: "학과" },
  dept_bioenv: { name: "생물환경화학과", color: "indigo", category: "학과" },
  dept_foodtech: { name: "식품공학과", color: "indigo", category: "학과" },
  dept_fshn: { name: "식품영양학과", color: "indigo", category: "학과" },
  dept_child: { name: "아동학과", color: "indigo", category: "학과" },
  dept_english: { name: "영어영문학과", color: "indigo", category: "학과" },
  dept_ethedu: { name: "윤리교육학과", color: "indigo", category: "학과" },
  dept_fashion: { name: "의류학과", color: "indigo", category: "학과" },
  dept_crop: { name: "작물생명과학과", color: "indigo", category: "학과" },
  dept_electronics: { name: "전자공학부", color: "indigo", category: "학과" },
  dept_political: { name: "정치외교학과", color: "indigo", category: "학과" },
  dept_housing: { name: "주거환경학과", color: "indigo", category: "학과" },
  dept_chinese: { name: "중어중문학과", color: "indigo", category: "학과" },
  dept_earthedu: { name: "지구과학교육학과", color: "indigo", category: "학과" },
  dept_csai: { name: "컴퓨터인공지능학부", color: "indigo", category: "학과" },
  dept_statistics: { name: "통계학과", color: "indigo", category: "학과" },
  dept_french: { name: "프랑스아프리카학과", color: "indigo", category: "학과" },
  dept_admin: { name: "행정학과", color: "indigo", category: "학과" },
  dept_chemistry: { name: "화학과", color: "indigo", category: "학과" },
  dept_chemical: { name: "화학공학부", color: "indigo", category: "학과" },
  dept_chemedu: { name: "화학교육학과", color: "indigo", category: "학과" },
  dept_accounting: { name: "회계학과", color: "indigo", category: "학과" },
